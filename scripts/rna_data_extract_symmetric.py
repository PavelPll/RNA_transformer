...
# sequence_names = ["symmetric"] * len(sequences)
sequence_names = []

print("Generating symmetric sequences")
sequences_symmetric = []
for seq in tqdm(sequences):
    sequences_symmetric.append(seq + seq)
    sequence_names.append("symmetric_abab")
    sequences_symmetric.append(seq + seq[::-1]) 
    sequence_names.append("symmetric_abba")
sequences = sequences_symmetric
print("Number of symmetric sequences:", len(sequences))
print("Example", sequences[1000], sequences[1001])
...
path_file = "../data/raw/data_rna_central/general_dataframes/general_rnafm_symmetric_9nucl_full.csv"
